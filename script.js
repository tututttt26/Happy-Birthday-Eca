...
new TypeIt("#teks1", {
  strings: ["Haiii Ecaaa!!! Selamat Ulang tahun ya!!!", "Caaa!!! semoga hal-hal yang membuat kamu runtuh turut menjadi alasan kamu untuk tetap tumbuh yaaa!!!.", "Semoga dunia senantiasa menjaga kamu dimanapun kamu berada.", "Semoga hari-hari kamu selalu diiringi cinta yang tak pernah ada batasnya." , "Website ini khusus dibuat untuk kamu caaa butuh 2 malam cuma untuk bikin web sesimpel ini,Sekalian belajar juga yakan."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpaku, semoga semesta selalu membahagiakan kamu bagimanapun caranya.", " ", "barakallah fi umrik, kamu kuat kok ca kamu mampu bertahan sampai hari ini!!!!.", " ", "- Wish all you the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
